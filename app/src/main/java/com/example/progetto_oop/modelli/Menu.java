...
public class Menu {
        ...
        public static int getImage(Cocktail cocktail) {
        ...
        public static Cocktail[] getListaAnalcolici() {
                Cocktail[] Analcolici = new Cocktail[19];
                int i = 0;
                int j = 0;
                for (Cocktail e : Menu.getCocktail()) {
                        ...
                        if (i == 19)
                                break;
                        Analcolici[i] = new Cocktail(e.id, e.nome, e.ingredients, e.difficulty, e.time, e.category, e.preparation, e.salvata);
